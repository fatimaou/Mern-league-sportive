...
const CAROUSEL_DATA = [
  {
    url: 'https://www.decathlonpro.fr/media/wysiwyg/marques/sport_de_raquettes.jpg',
  },
  {
    url: 'https://www.decathlonpro.fr/media/wysiwyg/marques/sports_collectifs.jpg',
  },
];
const Carousel = () => {
  ...
  return (
    <section className='h-carousel relative bg-red-300'>
      ...
      <div className='absolute h-full w-full top-0 left-0 flex flex-col justify-center items-center text-white uppercase px-4 text-center'>
        <h1 className='text-4xl md:text-6xl font-bold mb-8'> Soldes  </h1>
        <p className='tracking-wider mb-16 text-md md:text-xl'>
         Obtenez une remise de 30% sur les nouveaux équipements sportifs .
        </p>
        <Link
          to='categories'
          spy={true}
